...
<html>
<head>
<head><title>Inscriere la activitate</title>
<meta charset="UTF-8">
...
<div class="w3-row-padding w3-light-grey w3-padding-16 w3-container">
  ...
  <div class="w3-twothird">
    <h1>Adaugare Proiect</h1>
      <h5 class="w3-padding-32"> Alegeti elevul:</h5>
    </div>
...
<form method="post" action="ActiuneNoua.php">
    <div class="w3-twothird">

	<select name="elev" id="elev"> 
<?php
//activitate
...
$query = "select users.id_user,  users.username from users INNER JOIN regitrations ON (regitrations.id_user=users.id_user AND regitrations.id_activity='".$activitate."' )";
	...
	$_SESSION['activitate']=$activitate;
?>
 </select>   
Numarul de ore acumulate: <input type="number" name="ore">
