...
<html>
<head>
<head><title>Adaugare Proiect</title>
<meta charset="UTF-8">
...
<div class="w3-row-padding w3-light-grey w3-padding-16 w3-container">
  ...
  <div class="w3-twothird">
    <h1>Adaugare Proiect</h1>
      <h5 class="w3-padding-32"> Pentru a adauga un proiect nou completati urmatoarele casute: </h5>
    </div>
...
<form method="post" action="PHP/ProiectNou.php">
    <div class="w3-twothird">

       Nume Proiect: <br>&nbsp;<input type="Text" name="Nume"><br>
	   Descriere Proiect: <br>&nbsp;<input type="Text" name="Descriere"><br>
       Data inceperii(ll/zz/aaaa): <br>&nbsp;<input type="Date" name="DataI"><br>
       Data finalizarii(ll/zz/aaaa): <br>&nbsp;<input type="Date" name="DataF"><br>	   
